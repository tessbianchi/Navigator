...
public:
    ...
    Model model;
    bool determine_model_position(vector<Eigen::Vector3d>& model_position, int max_corners, int block_size, double min_distance, double image_proc_scale, int diffusion_time,
